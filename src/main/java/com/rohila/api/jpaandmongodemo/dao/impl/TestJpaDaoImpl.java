...
import com.rohila.api.jpaandmongodemo.repository.jpa.TestJpaRepository;
...
@Component
public class TestJpaDaoImpl implements TestDao {
    ...
    /* @@_BEGIN: MEMBERS --------------------------------------------*/
    private TestJpaRepository testRepository;

    public TestJpaDaoImpl(TestJpaRepository testRepository) {
